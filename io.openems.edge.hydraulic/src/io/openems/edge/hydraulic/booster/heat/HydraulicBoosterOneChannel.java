...
@Component(name = "Hydraulic.Booster.OneChannel",
        immediate = true,
        configurationPolicy = ConfigurationPolicy.REQUIRE,
        property = EventConstants.EVENT_TOPIC + "=" + EdgeEventConstants.TOPIC_CYCLE_AFTER_CONTROLLERS)
public class HydraulicBoosterOneChannel extends AbstractOpenemsComponent implements OpenemsComponent, EventHandler, HeatBooster {

    private final Logger logger = LoggerFactory.getLogger(HydraulicBoosterOneChannel.class);
    ...
    public HydraulicBoosterOneChannel() {
