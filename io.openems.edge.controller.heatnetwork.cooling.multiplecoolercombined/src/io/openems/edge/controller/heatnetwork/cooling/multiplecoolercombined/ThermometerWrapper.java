...
/**
 * This class helps to get the Correct Thermometer of the corresponding Cooler as well as "setPoints" for the Thermometer.
...
class ThermometerWrapper {
     ...
     * This is determined, if the channelAddressOrValue String (usually from MultiCoolerConfig) contains only numbers,
    ...
    /**
     * Method, usually called by the {@link MultipleCoolerCombinedControllerImpl}
     * to determine if the {@link CoolerActiveWrapper#setActive(boolean)} with value false should be called.
     *
    ...
    /**
     * Method, usually called by the {@link MultipleCoolerCombinedControllerImpl}
     * to determine if the {@link CoolerActiveWrapper#setActive(boolean)} with value true should be called.
     *
