...
public class TypeUtils {
        ...
        switch (type) {
            ...
            case SHORT:
                if (value == null) {
                    ...
                    stringValue = checkForFloatingPointAndSplit(stringValue);
            ...
            case LONG:
                if (value == null) {
                    ...
                    checkForFloatingPointAndSplit(stringValue);
    ...
    private static String checkForFloatingPointAndSplit(String stringValue) {
        if (stringValue.contains(".") && stringValue.matches("[-+]?([0-9]*[.][0-9]+|[0-9]+)")) {
            String[] splitString = stringValue.split("\\.");
            stringValue = splitString[0];
        }
        return stringValue;
    }
