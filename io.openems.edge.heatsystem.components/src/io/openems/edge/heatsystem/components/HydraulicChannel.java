 ...
 */
public interface HydraulicChannel extends OpenemsComponent {
    ...
    default WriteChannel<Double> maxValueChannel() {
        return this.channel(HydraulicChannel.ChannelId.MAX_ALLOWED_VALUE);
    }
    ...
    default WriteChannel<Double> minValueChannel() {
        return this.channel(HydraulicChannel.ChannelId.MIN_ALLOWED_VALUE);
    }
