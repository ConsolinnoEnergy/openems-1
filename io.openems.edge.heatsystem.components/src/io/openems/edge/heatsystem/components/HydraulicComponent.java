 ...
 */
public interface HydraulicComponent extends OpenemsComponent {
    ...
    default WriteChannel<Double> maxValueChannel() {
        return this.channel(HydraulicComponent.ChannelId.MAX_ALLOWED_VALUE);
    }
    ...
    default WriteChannel<Double> minValueChannel() {
        return this.channel(HydraulicComponent.ChannelId.MIN_ALLOWED_VALUE);
    }
    ...
    int WAIT_TIME_CHECK_COMPONENTS = 30;
}
