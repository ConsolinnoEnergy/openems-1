...
public class AnalogueHeater extends AbstractOpenemsComponent implements OpenemsComponent, Heater, EventHandler {
    ...
    private List<AnalogueHeaterComponent> heaterComponent = new ArrayList<>();
    ...
    public void handleEvent(Event event) {
        ...
        if (event.getTopic().equals(EdgeEventConstants.TOPIC_CYCLE_BEFORE_PROCESS_IMAGE)) {
            ...
            try {
                ...
                this.updatePowerChannel(this.heaterComponent.stream().findAny().get().getCurrentPowerApplied());
            } catch (OpenemsError.OpenemsNamedException e) {
