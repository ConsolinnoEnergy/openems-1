...
public class AnalogueHeaterAIO extends AbstractAnalogueHeaterComponent implements AnalogueHeaterComponent {
    ...
    public AnalogueHeaterAIO(ComponentManager cpm, String analogueId, int maxPowerKw, ControlType controlType, int defaultMinPower) throws OpenemsError.OpenemsNamedException {
