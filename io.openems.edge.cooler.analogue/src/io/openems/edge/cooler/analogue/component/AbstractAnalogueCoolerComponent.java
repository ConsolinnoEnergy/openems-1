...
public abstract class AbstractAnalogueCoolerComponent implements AnalogueCoolerComponent {
    ...
    @Override
    public void startCooling(int powerToApply) throws OpenemsError.OpenemsNamedException {
    ...
    @Override
    public void stopCooling() throws OpenemsError.OpenemsNamedException {
