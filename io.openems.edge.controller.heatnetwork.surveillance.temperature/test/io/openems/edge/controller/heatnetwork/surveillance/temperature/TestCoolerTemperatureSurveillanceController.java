...
public class TestCoolerTemperatureSurveillanceController {
    ...
    private static final int offsetActivate = 0;
    private static final String thermometerDeactivateId = "Thermometer2";
    private static final int offsetDeactivate = 0;
    ...
    private static final String coolerId = "Cooler0";
    ...
    private static final String[] componentStringsToActivate = {referenceThermometerId, thermometerActivateId,
            thermometerDeactivateId, valveControllerId, coolerId, timerTime, timerCycles};
    private static final int timeToWaitValveOpen = 1;
    ...
    public void heaterRunsAndValveControllerEnabledAfterTimeIsUp() throws Exception {
        ...
        this.cpm.addComponent(new DummyCooler(coolerId));
        ...
        new ControllerTest(new TemperatureSurveillanceControllerCoolingImpl(), components)
                .addReference("cpm", this.cpm)
                .activate(MyCoolerConfig.create()
                        .setId(id)
                        .setCoolerId(coolerId)
                        .setEnabled(enabled)
                        ...
                        .setService_pid("EverythingIsFineCoolerAndValve")
                        .setTimerId(timerCycles)
                        .build())
                //Nothing is Cooling
                .next(new TestCase()
                        .timeleap(this.clock, 1, ChronoUnit.SECONDS)
                        .input(this.channelAddresses.get(referenceThermometerId), 650)
                        .input(this.channelAddresses.get(thermometerActivateId), 500)
                        .input(this.channelAddresses.get(thermometerDeactivateId), 900)
                )
                .next(new TestCase()
                        .timeleap(this.clock, 1, ChronoUnit.SECONDS)
                        .output(this.channelAddresses.get(coolerId), null)
                )
                .next(new TestCase()
                        .timeleap(this.clock, 1, ChronoUnit.SECONDS)
                        .output(this.channelAddresses.get(coolerId), null)
                ...
                //Cooler should activate
                .next(new AbstractComponentTest.TestCase()
                        .timeleap(this.clock, 1, ChronoUnit.SECONDS)
                        .input(this.channelAddresses.get(thermometerActivateId), 900)
                        .output(this.channelAddresses.get(coolerId), true)
                )
                .next(new AbstractComponentTest.TestCase()
                        .timeleap(this.clock, 1, ChronoUnit.SECONDS)
                        .output(this.channelAddresses.get(coolerId), true)
    ...
    public void heaterRuns() throws Exception {
        ...
        new ControllerTest(new TemperatureSurveillanceControllerCoolingImpl(), components)
                ...
                .next(new TestCase()
                        .timeleap(this.clock, 1, ChronoUnit.SECONDS)
                        .input(this.channelAddresses.get(referenceThermometerId), 700)
                        .input(this.channelAddresses.get(thermometerActivateId), 800)
    ...
    public void valveRuns() throws Exception {
        ...
        new ControllerTest(new TemperatureSurveillanceControllerCoolingImpl(), components)
                ...
                .next(new TestCase()
                        ...
                        .input(this.channelAddresses.get(thermometerDeactivateId), 400)
    ...
    public void heaterRunsAndThenDeactivatesAndStaysInactive() throws Exception {
        ...
        new ControllerTest(new TemperatureSurveillanceControllerCoolingImpl(), components)
                ...
                .next(new TestCase()
                        ...
                        .input(this.channelAddresses.get(coolerId), null)
                        .output(this.channelAddresses.get(coolerId), null))
                .getSut().run();
    }
    ...
    public void heaterRunsAndValveControllerEnabledAfterConfigIsOk() throws Exception {
        ...
        new ControllerTest(new TemperatureSurveillanceControllerCoolingImpl(), components)
                ...
                .activate(MyCoolerConfig.create()
                        ...
                        .setTimerId(timerCycles)
                        .build())
                .addComponent(this.getAndAddPreviouslyToCpm(coolerId))
                //Everythings heating
                .next(new TestCase()
                        .timeleap(this.clock, 1, ChronoUnit.SECONDS)
                        .input(this.channelAddresses.get(referenceThermometerId), 300)
                        .input(this.channelAddresses.get(thermometerActivateId), 500)
    ...
    public void wrongConfigured() {
        try {
            ...
            OpenemsComponent[] components = new OpenemsComponent[this.cpm.getAllComponents().size() - 1];
            components = this.cpm.getAllComponents().toArray(components);
            OpenemsComponent cpmThatIsMissing = new DummyCooler(coolerId);
            new ControllerTest(new TemperatureSurveillanceControllerCoolingImpl(), components)
                    .addReference("cpm", this.cpm)
                    .activate(MyCoolerConfig.create()
                            .setId(id)
    ...
    private OpenemsComponent getAndAddPreviouslyToCpm(String componentId) {
        OpenemsComponent component = new DummyCooler(componentId);
