...
import io.openems.edge.heater.decentralized.test.DummyDecentralizedCooler;
...
public class MyHydraulicLineCoolerControllerTest {
    ...
    //ActivationTemp
    private static final String correctReferenceTemperature = "250";
    ...
    //decentralizedHeater
    private static final String decentralizedCoolerId = "Heater0";
    private static final DummyDecentralizedCooler dummyDecentralizedHeater
            = new DummyDecentralizedCooler(decentralizedCoolerId);
    private static final DecentralizedCoolerReactionType reactionType = DecentralizedCoolerReactionType.NEED_COOL;
    private static final ChannelAddress decentralizedCoolerAddress = new ChannelAddress(decentralizedCoolerId, "NeedCool");
    //Basic
    ...
    public void oneChannelLineHeaterNoFallbackNoDecentralized() throws Exception {
        HydraulicLineCoolerController controller = new HydraulicLineCoolerController();
        ...
        new ControllerTest(controller, components)
                ...
                .activate(MyHydraulicLineCoolerConfig.create()
                        .setId(id)
                        ...
                        .setUseDecentralizedCooler(false)
                        .setDecentralizedCoolerReference(decentralizedCoolerId)
    ...
    public void decentralizedOneChannel() throws Exception {
        ...
        new ControllerTest(controller, components)
                ...
                .activate(MyHydraulicLineCoolerConfig.create()
                        ...
                        .setMaxValveValue(defaultMaxValue)
                        .setMinValveValue(defaultMinValue)
                        .setUseDecentralizedCooler(true)
                        .setDecentralizedCoolerReference(decentralizedCoolerId)
                        .setReactionType(reactionType)
                        .setEnabled(true)
                        .build())
                .next(new TestCase()
                        .timeleap(clock, 1, ChronoUnit.SECONDS)//not strictly necessary but some things just won't work sometimes otherwise
                        .input(thermometerAddress, 600)
                        .input(decentralizedCoolerAddress, true)
                        .output(apartmentModuleAddress, true)
                )
                .next(new TestCase()
                        .input(decentralizedCoolerAddress, true)
