...
public class MyHydraulicLineCoolerConfig extends AbstractComponentConfig implements ConfigLineCooler {
    ...
    protected static class Builder {
        ...
        private boolean useDecentralizedCooler;
        private String decentralizedCoolerReference;
        private DecentralizedCoolerReactionType reactionType;
        ...
        public Builder setUseDecentralizedCooler(boolean useDecentralizedCooler) {
            this.useDecentralizedCooler = useDecentralizedCooler;
            return this;
        }

        public Builder setDecentralizedCoolerReference(String decentralizedCoolerReference) {
            this.decentralizedCoolerReference = decentralizedCoolerReference;
            return this;
        }

        public Builder setReactionType(DecentralizedCoolerReactionType reactionType) {
            this.reactionType = reactionType;
            return this;
        }

        public MyHydraulicLineCoolerConfig build() {
            return new MyHydraulicLineCoolerConfig(this);
        }
    }
    ...
    private MyHydraulicLineCoolerConfig(Builder builder) {
        super(MyHydraulicLineCoolerConfig.class, builder.id);
    ...
    @Override
    public boolean useDecentralizedCooler() {
        return this.builder.useDecentralizedCooler;
    }

    @Override
    public String decentralizedCoolerReference() {
        return this.builder.decentralizedCoolerReference;
    }

    @Override
    public DecentralizedCoolerReactionType reactionType() {
