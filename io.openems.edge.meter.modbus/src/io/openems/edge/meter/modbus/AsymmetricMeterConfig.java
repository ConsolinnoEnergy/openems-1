...
@ObjectClassDefinition(name = "Modbus Meter Electricity Asymmetric Generic ", description = "A Generic Modbus Electricity Asymmetric Meter, Configure the Meter, as you please.")
@interface AsymmetricMeterConfig {
    ...
    String webconsole_configurationFactory_nameHint() default "Modbus Meter Electricity Asymmetric Generic {id}";
}
