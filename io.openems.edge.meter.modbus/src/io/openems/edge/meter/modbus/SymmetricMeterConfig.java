...
@ObjectClassDefinition(name = "Modbus Meter Electricity Symmetric Generic ", description = "A Generic Modbus Electricity Symmetric Meter, Configure the Meter, as you please.")
@interface SymmetricMeterConfig {
