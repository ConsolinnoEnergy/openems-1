...
@ObjectClassDefinition(
        name = "Storage Heat Modbus Triple",
        description = "A module to map Modbus calls to OpenEMS channels for a Generic Modbus HeatStorageTriple Module."
)
@interface TripleConfig {

    String service_pid();

    @AttributeDefinition(name = "Device ID", description = "Unique Id of the HeatStorageTriple Module.")
    ...
    @AttributeDefinition(name = "Modbus Register first temp sensor", description = "Modbus Register first temp sensor.")
    int modbusRegisterTempFirst() default -1;
    @AttributeDefinition(name = "Modbus Register second temp sensor", description = "Modbus Register second temp sensor.")
    int modbusRegisterTempSecond() default -1;
    @AttributeDefinition(name = "Modbus Register third temp sensor", description = "Modbus Register third temp sensor.")
